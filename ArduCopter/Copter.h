...
# include USERHOOK_VARIABLES
 ...
 #error Unrecognised frame type
    ...
    void Log_Write_VisionPose_AH(uint8_t _marker, int _frame_number, float _z);
    void Log_Write_VisionPose_XY(uint8_t _marker, int _frame_number, Vector3f _pos_ned, Vector3f _vel_ned, float _roll, float _pitch, float _yaw_rad, float _z_sp);
